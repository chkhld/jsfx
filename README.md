...
## Included effects
- [Correlation Meter](https://github.com/chkhld/jsfx/blob/master/plugins/correlation_meter.jsfx): Inspect stereo phase balance and find mono-problematic areas by watching an indicator go red.
